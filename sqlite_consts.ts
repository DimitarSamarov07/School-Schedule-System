...
class Sqlite_consts {
    static readonly SELECT_SCHEDULES_FOR_DATE = `SELECT cl.Name as 'className', c.Name as 'courseName', CONCAT(t.FName, ' ', t.LName) as 'fullTeacherName', r.Name as 'roomNumber', r.Floor as 'floor'
                                                 FROM Schedule
