    ...
    return (
        <div className="max-w-9xl mx-auto p-6">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900">Управлявайте учителите</h2>
                    <p className="text-sm text-gray-500 mt-1">Конфигурирайте и организирайте учители.</p>
                </div>
                ...
                {!manager.isLoading && manager.teacherList.length > 0 && (
                    ...
                    >
                        <Plus className="w-4 h-4"/> Добави учител
                    </button>
                )}
            </div>
